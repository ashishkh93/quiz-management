...
export default function AssignModeratorPopup() {
    ...
    const handleSave = (data: ModeratorFormValues) => {
        console.log("Moderator submitted:", data);
    };
                    ...
                    <DialogHeader className="px-6 py-4 border-b">
                        <div className="flex items-center justify-between">
                            <DialogTitle className="text-lg font-semibold">
                                {currentView === "assign" ? "Assign Moderator" : "Create New Moderator"}
                            </DialogTitle>
                        </div>
                    </DialogHeader>
                    ...
                    {currentView === "assign" ? (
                        <div className="px-6 py-4">
                            <div className="flex gap-2 mb-4">
                                ...
                                <Button onClick={handleCreateNew} className="bg-blue-600 hover:bg-blue-700 text-white px-4">
                                    Create New
                                </Button>
                            </div>
                            ...
                            <div className="max-h-80 overflow-y-auto">
                                <div className="space-y-1">
                                    {moderatorData.length > 0 && moderatorData?.map((user: any) => (
                                        <div
                                            key={user.id}
